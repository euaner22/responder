...
import 'package:juantap/pages/admin/main.dart' as admin;
import 'package:juantap/pages/responders/main.dart' as responder;
          ...
          if (uid != null) {
            ...
            if (role == 'admin') {
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (context) => const admin.admin()),
              );
            } else if (role == 'responder') {
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (context) => const responder.MyHomePage(title: 'Responder')),
              );
            } else {
              Navigator.pushReplacement(
                context,
